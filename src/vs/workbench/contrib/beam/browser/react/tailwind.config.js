	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--beam-fg-1)',
						'--tw-prose-headings': 'var(--beam-fg-1)',
						'--tw-prose-lead': 'var(--beam-fg-2)',
						'--tw-prose-links': 'var(--beam-link-color)',
						'--tw-prose-bold': 'var(--beam-fg-1)',
						'--tw-prose-counters': 'var(--beam-fg-3)',
						'--tw-prose-bullets': 'var(--beam-fg-3)',
						'--tw-prose-hr': 'var(--beam-border-4)',
						'--tw-prose-quotes': 'var(--beam-fg-1)',
						'--tw-prose-quote-borders': 'var(--beam-border-2)',
						'--tw-prose-captions': 'var(--beam-fg-3)',
						'--tw-prose-code': 'var(--beam-fg-0)',
						'--tw-prose-pre-code': 'var(--beam-fg-0)',
						'--tw-prose-pre-bg': 'var(--beam-bg-1)',
						'--tw-prose-th-borders': 'var(--beam-border-4)',
						'--tw-prose-td-borders': 'var(--beam-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'beam-bg-1': 'var(--beam-bg-1)',
				'beam-bg-1-alt': 'var(--beam-bg-1-alt)',
				'beam-bg-2': 'var(--beam-bg-2)',
				...
				'beam-fg-1': 'var(--beam-fg-1)',
				'beam-fg-2': 'var(--beam-fg-2)',
				'beam-fg-3': 'var(--beam-fg-3)',
				// 'beam-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'beam-fg-4': 'var(--beam-fg-4)',

				'beam-warning': 'var(--beam-warning)',

				'beam-border-1': 'var(--beam-border-1)',
				'beam-border-2': 'var(--beam-border-2)',
				'beam-border-3': 'var(--beam-border-3)',
				'beam-border-4': 'var(--beam-border-4)',

				'beam-ring-color': 'var(--beam-ring-color)',
				'beam-link-color': 'var(--beam-link-color)',
