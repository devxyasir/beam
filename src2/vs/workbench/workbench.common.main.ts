...
//#region --- Beam
import './contrib/beam/browser/beam.contribution.js'; // Beam added this
//#endregion
...
// Chat
// Beam - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
