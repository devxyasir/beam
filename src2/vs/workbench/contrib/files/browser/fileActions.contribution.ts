...
import { BEAM_OPEN_SETTINGS_ACTION_ID } from '../../beam/browser/beamSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openVoid', comment: ['&& denotes a mnemonic'] }, "&&Open Beam Settings"),
	},
	order: 1
});
