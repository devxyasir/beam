...
import { TextAreaFns, BeamInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, BeamChatArea } from '../sidebar-tsx/SidebarChat.js';
import { BEAM_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/beam/common/beamSettingsTypes.js';
...
export const QuickEditChat = ({
  ...
  const loadingIcon = <div
    className="codicon codicon-loading codicon-modifier-spin codicon-no-default-spin beam-text-beam-fg-3" />;
  ...
  const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(BEAM_CTRL_K_ACTION_ID)?.getLabel();

  const chatAreaRef = useRef<HTMLDivElement | null>(null);
  return <div ref={sizerRef} style={{ maxWidth: 450 }} className={`beam-py-2 beam-w-full`}>
		<BeamChatArea
      featureName='Ctrl+K'
      divRef={chatAreaRef}
      onSubmit={onSubmit}
