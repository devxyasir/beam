...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './beamSettingsTypes.js';
...
export type BeamStaticModelInfo = { // not stateful
	// Beam uses the information below to know how to handle each model.
...
type BeamStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: BeamStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<BeamStaticModelInfo>) => (BeamStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies BeamStaticModelInfo
...
} as const satisfies { [s: string]: Partial<BeamStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: BeamStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<BeamStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: BeamStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: BeamStaticModelInfo }

const anthropicSettings: BeamStaticProviderInfo = {
...
const openAISettings: BeamStaticProviderInfo = {
...
const xAISettings: BeamStaticProviderInfo = {
...
const geminiSettings: BeamStaticProviderInfo = {
...
const deepseekSettings: BeamStaticProviderInfo = {
...
const mistralSettings: BeamStaticProviderInfo = {
...
const groqSettings: BeamStaticProviderInfo = {
...
} as const satisfies Record<string, BeamStaticModelInfo>
const googleVertexSettings: BeamStaticProviderInfo = {
...
const microsoftAzureSettings: BeamStaticProviderInfo = {
...
const awsBedrockSettings: BeamStaticProviderInfo = {
...
const vLLMSettings: BeamStaticProviderInfo = {
...
const lmStudioSettings: BeamStaticProviderInfo = {
...
const ollamaSettings: BeamStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: BeamStaticProviderInfo = {
...
const liteLLMSettings: BeamStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: BeamStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: BeamStaticProviderInfo } = {
