...
Beam separately records basic usage like the number of messages people are sending. If you'd like to disable Beam metrics, you may do so in Beam's Settings.
`;
