...
const TaskPlanProgress = ({ taskPlan }: { taskPlan: TaskPlan }) => {
	...
	return (
		<div className='@@beam-plan-card @@beam-task-plan @@beam-message-enter mt-2 w-[min(100%,620px)] overflow-hidden rounded-lg border border-[rgba(255,255,255,0.06)] bg-[#17171a]'>
			<button
				type='button'
			...
			<div className='px-2 pb-2'>
				<div className='@@beam-task-plan-list overflow-hidden rounded-md border border-[rgba(255,255,255,0.05)] bg-[#1e1e22] px-2 py-1.5'>
...
const AgentRunTimeline = ({ threadId, userMessageIndex }: { threadId: string; userMessageIndex: number }) => {
	...
	return <div className='@@beam-agent-run mt-2 w-[min(100%,520px)] overflow-hidden rounded-lg border border-[rgba(255,255,255,0.06)] bg-[#17171a]'>
		<button
			type='button'
		...
		>
			<div className='flex min-w-0 items-center gap-2'>
				...
				<span className='truncate text-sm font-medium text-[#f0f0f2]'>{label}</span>
			</div>
			<span className='shrink-0 rounded bg-[#1e1e22] px-1.5 py-0.5 text-xs text-[#65656e]'>
				{run.events.length} event{run.events.length === 1 ? '' : 's'}
			</span>
		</button>
		{isOpen && <div className='border-t border-[rgba(255,255,255,0.05)] px-3 py-2'>
